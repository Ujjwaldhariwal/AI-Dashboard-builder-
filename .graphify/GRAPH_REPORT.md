...
## Corpus Check
- 261 files · ~177,003 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1981 nodes · 5699 edges · 89 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output
- Edge kinds: contains: 1475 · imports: 1184 · MODIFIES: 1077 · imports_from: 728 · calls: 439 · ON_BRANCH: 390 · PARENT_OF: 249 · references: 105 · method: 45 · inherits: 5 · re_exports: 2


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 261 · Candidates: 277
- Excluded: 3 untracked · 87620 ignored · 2 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `2360297`
- Compare this hash to `git rev-parse HEAD` before trusting freshness-sensitive graph output.
## God Nodes (most connected - your core abstractions)
1. `Button` - 49 edges
2. `Badge()` - 43 edges
3. `requireProjectAccess()` - 27 edges
4. `getAuthedSupabase()` - 27 edges
5. `AccessContext` - 26 edges
6. `Card` - 25 edges
...
Cohesion: 0.05
Nodes (68): GET(), POST(), requireAuditAccess(), 00aea45 feat: harden platform access and query telemetry, 5eccbb3 feat: track schema introspection freshness, 8bc4aa2 feat: add DashboardOS platform foundation, DataSourceCreateSchema, GET() (+60 more)
...
Cohesion: 0.08
Nodes (34): applyTransforms(), getWidgetCardHeightClass(), getWidgetGridSpanClass(), getWidgetSizePreset(), PRESET_POSITION, chartTypeIcon, inferCategoryField(), inferNumericField() (+26 more)
...
Cohesion: 0.13
Nodes (31): WidgetSizePreset, COMPACT_CHART_MARGIN, DEFAULT_CHART_MARGIN, getCategoryTickInterval(), getChartMargin(), getLegendVisibility(), normalizeSizePreset(), showValueLabels() (+23 more)
...
Cohesion: 0.09
Nodes (23): 3c6e599 feat: add admin chart composer, 48be0f0 style: add Monokai admin theme, 564cdeb feat: gate chart publishing with validation, a977d05 refactor: extract chart health auditor, ec0739b feat: show chart audit health in admin, DashboardChartsAdminPanel(), DatasetPlan, defaultEncoding() (+15 more)

### Community 15 - "Community 15"
Cohesion: 0.08
Nodes (23): buildEndpointRequestInit(), EndpointRequestOptions, AGGREGATE_REDUCERS, asRecord(), DataPrepModalProps, DATE_FORMAT_OPTIONS, FILTER_OPERATORS, isAggregateReducer() (+15 more)
...
Cohesion: 0.11
Nodes (23): FieldMappingSchema, GET(), mapEntity(), mapField(), POST(), semanticKey(), DashboardUpdateSchema, mapBusinessModel() (+15 more)
...
Cohesion: 0.13
Nodes (21): 03090c8 docs: refresh db dashboard handoff context, 5caf9c9 feat: expose query runtime history, 63029fc feat: revalidate client chart runtime, c2be49d feat: rate limit query runtime calls, e929a78 feat: persist chart health snapshots, f22b8bd feat: add chart health audit endpoint, f3635b1 chore: remove legacy builder schema, f3cd521 feat: add client chart runtime endpoint (+13 more)
...
Cohesion: 0.19
Nodes (18): cleanupIdlePostgresPools(), createPostgresClient(), decryptPostgresCredential(), evictOldestIdlePool(), executePostgresReadOnlyQuery(), getPostgresPool(), globalForPostgresPools, introspectPostgresSchema() (+10 more)
...
Cohesion: 0.16
Nodes (10): ModernBarChart(), ModernBarChartProps, normalizeLabel(), toCompactDateLabel(), TooltipParam, useEnterpriseTheme(), XAxisLayout, 3ef347e fix(charts): normalize margins, fix height chain, responsive legends/ticks (+2 more)
...
Cohesion: 0.24
Nodes (6): TrendAnalyzer, TrendInsight, predictionConfig, trendConfig, WidgetInsights(), WidgetInsightsProps
...
Cohesion: 0.36
Nodes (7): ModernGaugeChart(), ModernGaugeChartFromData(), ModernGaugeChartProps, useEnterpriseTheme(), useIsDarkMode(), 06b820f feat(sprint-1): migrate all charts to ECharts — gradients, native gauge, smooth animations, enterprise theme, 6ca0a14 feat(charts): migrate pie, horizontal-bar to ECharts; replace gauge PieChart hack with native gauge series
...
## Knowledge Gaps
- **473 isolated node(s):** `nextConfig`, `config`, `root`, `apiRoots`, `inventoryPath` (+468 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 59`** (1 nodes): `AIInsightsEngine`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 65`** (1 nodes): `SchemaDetector`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 76`** (1 nodes): `AlertEngine`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 77`** (1 nodes): `DataAnalyzer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Button` connect `Community 3` to `Community 2`, `Community 17`, `Community 29`, `Community 15`, `Community 40`, `Community 44`, `Community 47`, `Community 13`, `Community 55`, `Community 8`, `Community 10`, `Community 31`, `Community 4`, `Community 30`, `Community 12`, `Community 36`, `Community 18`, `Community 19`, `Community 14`, `Community 23`, `Community 5`, `Community 35`, `Community 22`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `Badge()` connect `Community 3` to `Community 2`, `Community 17`, `Community 29`, `Community 20`, `Community 15`, `Community 40`, `Community 44`, `Community 47`, `Community 13`, `Community 26`, `Community 4`, `Community 30`, `Community 12`, `Community 14`, `Community 23`, `Community 5`, `Community 35`, `Community 31`, `Community 8`?**
