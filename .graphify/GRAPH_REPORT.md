...
Cohesion: 0.06
Nodes (57): Message, NaturalLanguageQueryProps, MagicPasteModalProps, CHART_TYPE_ROWS, chartIcons, chartTypeLabel, WidgetConfigDialogProps, CHART_TYPE_ROWS (+49 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (35): Alert, CorrelationResult, DataPoint, Insight, metadata, Annotation, AnnotationLayerProps, 0fb12d8 Merge pull request #1 from Ujjwaldhariwal/feature/widget-canvas (+27 more)
...
Cohesion: 0.06
Nodes (47): CACHE, CachedResponse, clearEndpointResponseCache(), EndpointCacheEntry, fetchWithEndpointCache(), asRecord(), AUTH_STATUS_CODES, buildEndpointCacheKey() (+39 more)
...
Cohesion: 0.14
Nodes (33): WidgetSizePreset, COMPACT_CHART_MARGIN, DEFAULT_CHART_MARGIN, getCategoryTickInterval(), getChartMargin(), getLegendVisibility(), normalizeSizePreset(), showValueLabels() (+25 more)

### Community 12 - "Community 12"
Cohesion: 0.08
Nodes (26): METRICS, PRINCIPLES, SPRINTS, REQUIREMENTS, typeBg, typeColor, typeIcon, FieldError (+18 more)
...
Cohesion: 0.08
Nodes (26): CHART_ICONS, ChartSuggester(), ChartSuggesterProps, AIChartGeneratorResult, AIChartSuggestion, generateAIChartSuggestions(), ChartScore, scoreChartTypes() (+18 more)
...
Cohesion: 0.09
Nodes (29): 2158669 feat: merge dashboard stats, 45fe3d1 feat: add widget edit dialog + improved chart tooltips and styling, 77dc457 feat: merge chart improvements, 7ddb0c2 feat: add settings page with profile, preferences, stats and danger zone, a33da71 feat: merge settings page, c5fdab2 feat: add ownerId to dashboards and stats bar to workspaces page, APIEndpoint, asRecord() (+21 more)

### Community 22 - "Community 22"
Cohesion: 0.11
Nodes (25): getWidgetCardHeightClass(), getWidgetGridSpanClass(), getWidgetSizePreset(), PRESET_POSITION, ModernGaugeChart(), ModernGaugeChartFromData(), ModernGaugeChartProps, useEnterpriseTheme() (+17 more)
...
Cohesion: 0.14
Nodes (27): alertPayload(), asOptionalString(), asRecord(), asStringArray(), configuredEmailProvider(), deliverEmail(), deliverPlatformAlert(), deliverResendEmail() (+19 more)
...
Cohesion: 0.09
Nodes (17): TrendAnalyzer, TrendInsight, applyTransforms(), predictionConfig, trendConfig, WidgetInsights(), WidgetInsightsProps, DashboardWidgetRefreshDetail (+9 more)
...
Cohesion: 0.11
Nodes (21): 023e3fb merge: sprint5-monitoring-ui → dev, 172d5f6 Merge branch 'main' of https://github.com/Ujjwaldhariwal/AI-Dashboard-builder- into dev, 1f4e14d feat(nav): redesign chart navigator to clean scrollable tab bar, 21ee7b8 merge(dev→main): enhanced token session timer chip, 2354c5d merge(dev): Sprint 3 — macOS double-decker group navigator, 2389a85 merge(dev→main): cleanup stash conflicts, stale branches, codex-skills, remove old docs, 49a12e6 feat(data): add safe declarative data transform layer with edit UI, 8a0b538 merge(dev): Sprint 4 — safe data transform layer with edit UI (+13 more)
...
Cohesion: 0.10
Nodes (13): FEATURES, STATS, STEPS, 0071301 Initial commit from Create Next App, nextConfig, config, AuthIssue, AuthState (+5 more)
...
Cohesion: 0.16
Nodes (19): buildOrderMap(), detectLabelComparator(), detectOrderMap(), LabelComparator, MONTHS, NamedValue, normalize(), ORDER_GROUPS (+11 more)
...
Cohesion: 0.12
Nodes (17): fetchTrainingProfiles(), profileDashboardEndpoints(), profileMapFromList(), TrainingFeedbackPayload, TrainingProfilesResponse, TrainingSummaryResponse, DEFAULT_PROFILE_DRIFT_FLAGS, EndpointMappingFeedback (+9 more)

### Community 45 - "Community 45"
Cohesion: 0.15
Nodes (13): MagicPasteModal(), WidgetConfigDialog(), dispatchDashboardWidgetRefresh(), DragDropCanvas(), DragDropCanvasProps, 1019d7d Overhaul builder caching, manual refresh flow, sizing, and premium health UI, 1083e5c Merge branch 'codex/builder-prefetch-cache-ui-overhaul', 8cc9f6c fix(builder): restore widget spans and make insights on-demand (+5 more)
...
Cohesion: 0.20
Nodes (12): AIFallbackInput, buildDeterministicCandidate(), computeFieldStats(), computeShapeSignature(), hashString(), MappingEngineInput, MappingEngineOptions, mergeSeedMapping() (+4 more)

### Community 51 - "Community 51"
Cohesion: 0.18
Nodes (13): DashboardShape, EndpointShape, ExportEndpoint, ExportGroup, ExportWidget, joinOriginAndPath(), resolveBaseUrl(), shouldUseBoschProxyFallback() (+5 more)
...
Cohesion: 0.22
Nodes (7): BASE_PROMPTS, ConfigChatbot(), ConfigChatbotProps, Message, STYLE_PROMPTS, StyleAction, WidgetAction

### Community 69 - "Community 69"
Cohesion: 0.22
Nodes (9): 0fa25a1 feat(export): dynamic ai feature bundling and byok env injection, 239a125 fix(export): harden standalone bosch proxy routing and auth defaults, 2866562 docs: add PROJECT_STATE.md blueprint, 676bfa8 feat(ai): implement structured subagents, strict schemas, and ai pdf report flow, 74e8979 feat(ui): revamp widget header and responsive app layout, 7ae5344 fix(export): prompt for absolute api base url during standalone export, 7b391ce fix(export): resolve login URL 404 and enforce standalone base URL preflight, 7c6cf59 feat(export): bundle bosch proxy in standalone export and remove base-url prompt (+1 more)
...
- **Thin community `Community 67`** (1 nodes): `SchemaDetector`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
