...
## Corpus Check
- 201 files · ~139,905 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1584 nodes · 4559 edges · 78 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output
- Edge kinds: contains: 1156 · imports: 961 · MODIFIES: 957 · imports_from: 598 · calls: 380 · PARENT_OF: 217 · ON_BRANCH: 185 · references: 55 · method: 45 · inherits: 3 · re_exports: 2
...
Cohesion: 0.06
Nodes (39): METRICS, PRINCIPLES, SPRINTS, Message, NaturalLanguageQueryProps, Annotation, AnnotationLayerProps, REQUIREMENTS (+31 more)

### Community 2 - "Community 2"
Cohesion: 0.08
Nodes (26): Alert, CorrelationResult, DataPoint, Insight, metadata, 0fb12d8 Merge pull request #1 from Ujjwaldhariwal/feature/widget-canvas, 4227041 feat: render widgets as live chart cards on builder page, 5397f64 feat(export): update config-builder, template-generator, zip-packager, pdf-export (+18 more)
...
Cohesion: 0.09
Nodes (29): MagicPasteModalProps, CHART_TYPE_ROWS, chartIcons, chartTypeLabel, WidgetConfigDialogProps, CHART_TYPE_ROWS, chartIcons, chartTypeLabel (+21 more)
...
Cohesion: 0.09
Nodes (27): 8bc4aa2 feat: add DashboardOS platform foundation, DatasetsAdminPanel(), EntityWithFields, ProjectOption, EntityWithFields, FIELD_ROLES, ProjectOption, mapRelationship() (+19 more)

### Community 9 - "Community 9"
Cohesion: 0.12
Nodes (30): WidgetSizePreset, COMPACT_CHART_MARGIN, DEFAULT_CHART_MARGIN, getCategoryTickInterval(), getChartMargin(), getLegendVisibility(), normalizeSizePreset(), ModernAreaChart() (+22 more)
...
Cohesion: 0.10
Nodes (24): ModernBarChart(), useEnterpriseTheme(), ModernGaugeChart(), ModernGaugeChartFromData(), ModernGaugeChartProps, useEnterpriseTheme(), useIsDarkMode(), ModernRingGaugeChart() (+16 more)
...
Cohesion: 0.10
Nodes (25): 50ab5c1 fix: persist widget layout via server API with bearer/cookie auth fallback, d5ef7e8 fix: avoid PATCH writes by using upsert for dashboard/endpoint/widget updates, APIEndpoint, asRecord(), CHART_TYPES, Dashboard, DashboardStore, dbId() (+17 more)
...
Cohesion: 0.15
Nodes (8): FEATURES, STATS, STEPS, 2a76277 feat(auth): add auth layout, login page, builder layout, 8be9d7f feat(auth): update login page, auth layout, notification bell, add auth-initializer, dc4b531 feat(auth-ui): refresh login/workspaces UX and extend project header config, AuthInitializer(), useAuthStore
...
Cohesion: 0.47
Nodes (4): mapMetric(), MetricSchema, POST(), semanticKey()

### Community 68 - "Community 68"
Cohesion: 0.53
Nodes (5): BusinessModelCreateSchema, GET(), isMissingSemanticSchema(), mapBusinessModel(), POST()
...
Cohesion: 0.40
Nodes (3): 0071301 Initial commit from Create Next App, nextConfig, config
...
## Knowledge Gaps
- **384 isolated node(s):** `nextConfig`, `config`, `OUTPUT_ROOT`, `ZIP_PATH`, `EXTRACT_DIR` (+379 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 47`** (1 nodes): `AIInsightsEngine`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 51`** (1 nodes): `SchemaDetector`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 62`** (1 nodes): `AlertEngine`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 63`** (1 nodes): `DataAnalyzer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 65`** (1 nodes): `PDFExporter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 70`** (1 nodes): `CorrelationEngine`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 72`** (1 nodes): `ErrorBoundaryClass`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Button` connect `Community 1` to `Community 7`, `Community 23`, `Community 4`, `Community 20`, `Community 40`, `Community 15`, `Community 6`, `Community 13`, `Community 36`, `Community 29`, `Community 9`, `Community 14`, `Community 11`, `Community 30`, `Community 25`, `Community 3`, `Community 8`, `Community 33`, `Community 21`, `Community 17`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `Badge()` connect `Community 1` to `Community 7`, `Community 23`, `Community 4`, `Community 20`, `Community 40`, `Community 15`, `Community 6`, `Community 13`, `Community 14`, `Community 11`, `Community 8`, `Community 33`, `Community 17`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `SchemaDetector` connect `Community 51` to `Community 2`?**
