...
## Corpus Check
- 202 files · ~140,764 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1593 nodes · 4581 edges · 77 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output
- Edge kinds: contains: 1162 · imports: 964 · MODIFIES: 961 · imports_from: 600 · calls: 383 · PARENT_OF: 219 · ON_BRANCH: 187 · references: 55 · method: 45 · inherits: 3 · re_exports: 2
...
Cohesion: 0.08
Nodes (40): METRICS, PRINCIPLES, SPRINTS, AUTH_HINTS, AuthType, BOSCH_UPPCL_PRESET, CHART_TYPE_OPTIONS, DEFAULT_FORM (+32 more)
...
Cohesion: 0.09
Nodes (33): MagicPasteModalProps, CHART_TYPE_ROWS, chartIcons, chartTypeLabel, WidgetConfigDialogProps, CHART_TYPE_ROWS, chartIcons, chartTypeLabel (+25 more)
...
Cohesion: 0.08
Nodes (21): Alert, CorrelationResult, DataPoint, Insight, metadata, 0fb12d8 Merge pull request #1 from Ujjwaldhariwal/feature/widget-canvas, 2a76277 feat(auth): add auth layout, login page, builder layout, 4227041 feat: render widgets as live chart cards on builder page (+13 more)

### Community 6 - "Community 6"
Cohesion: 0.08
Nodes (22): REQUIREMENTS, DataSourcesAdminPanel(), ProjectOption, REQUIREMENTS, SemanticModelAdminPanel(), ACCESS_RULES, TENANT_FLOW, TenantsAdminPanel() (+14 more)
...
Cohesion: 0.11
Nodes (22): DatasetPlan, EntityWithFields, ProjectOption, EntityWithFields, FIELD_ROLES, ProjectOption, BusinessEntity, BusinessField (+14 more)
...
Cohesion: 0.15
Nodes (17): 042fba1 feat: select semantic dataset assets, ef90211 feat: preview semantic dataset plans, DatasetSchema, mapDataset(), POST(), mapBusinessModel(), mapDataset(), PATCH() (+9 more)
...
Cohesion: 0.14
Nodes (12): mapMetric(), MetricSchema, POST(), semanticKey(), mapRelationship(), POST(), RelationshipSchema, GET() (+4 more)
...
Cohesion: 0.15
Nodes (8): Annotation, AnnotationLayerProps, cn(), TabsContent, TabsList, TabsTrigger, Textarea, TextareaProps
...
Cohesion: 0.21
Nodes (7): 8bc4aa2 feat: add DashboardOS platform foundation, dashboard_projects, data_sources, tenants, DatasetsAdminPanel(), NAV_ITEMS, PlatformAdminShell()
...
Cohesion: 0.20
Nodes (5): Message, NaturalLanguageQueryProps, 5676317 feat(viewer): modern charts, AI insights panel, chart card, PDF selector, NL query, viewer pages, Input, InputProps
...
- **Thin community `Community 52`** (1 nodes): `AIInsightsEngine`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 55`** (1 nodes): `SchemaDetector`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 68`** (1 nodes): `PDFExporter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 71`** (1 nodes): `CorrelationEngine`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Button` connect `Community 6` to `Community 1`, `Community 7`, `Community 21`, `Community 49`, `Community 18`, `Community 47`, `Community 14`, `Community 3`, `Community 12`, `Community 37`, `Community 32`, `Community 10`, `Community 42`, `Community 13`, `Community 9`, `Community 25`, `Community 26`, `Community 2`, `Community 20`, `Community 45`, `Community 29`, `Community 19`, `Community 38`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `Badge()` connect `Community 6` to `Community 1`, `Community 7`, `Community 21`, `Community 49`, `Community 18`, `Community 47`, `Community 14`, `Community 3`, `Community 12`, `Community 42`, `Community 13`, `Community 9`, `Community 20`, `Community 45`, `Community 29`, `Community 38`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `SchemaDetector` connect `Community 55` to `Community 64`?**
