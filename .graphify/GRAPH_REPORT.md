...
## Corpus Check
- 201 files · ~139,457 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1582 nodes · 4516 edges · 80 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output
- Edge kinds: contains: 1155 · imports: 958 · MODIFIES: 920 · imports_from: 598 · calls: 380 · PARENT_OF: 216 · ON_BRANCH: 184 · references: 55 · method: 45 · inherits: 3 · re_exports: 2


## Input Scope
- Requested: all
- Resolved: all (source: cli)
- Included files: 201 · Candidates: recursive
- Excluded: 0 untracked · 0 ignored · 2 sensitive · 0 missing committed

## Graph Freshness
- Built from Git commit: `b6bcb11`
...
Cohesion: 0.06
Nodes (31): Alert, CorrelationResult, DataPoint, Insight, metadata, Annotation, AnnotationLayerProps, 0fb12d8 Merge pull request #1 from Ujjwaldhariwal/feature/widget-canvas (+23 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (34): METRICS, PRINCIPLES, SPRINTS, REQUIREMENTS, typeBg, typeColor, typeIcon, DataSourcesAdminPanel() (+26 more)
...
Cohesion: 0.10
Nodes (31): AUTH_HINTS, AuthType, BOSCH_UPPCL_PRESET, CHART_TYPE_OPTIONS, DEFAULT_FORM, StatusType, AuthType, EMPTY_FORM (+23 more)
...
Cohesion: 0.10
Nodes (34): 4ea1b1b fix(api): support multi-env bosch proxy credentials and diagnostics, b50e3e0 feat(sprint-3): finalize supabase persistence and schema migration, auth.users, dashboards, endpoints, widgets, auth.users, dashboards (+26 more)
...
Cohesion: 0.11
Nodes (26): AxisLabelLayout, compactDateLabel(), getAxisLabelLayout(), normalizeCategoryLabel(), parseNumericInput(), truncateLabel(), wrapAxisLabel(), ModernBarChart() (+18 more)

### Community 10 - "Community 10"
Cohesion: 0.09
Nodes (25): CHART_COLORS, ModernGaugeChart(), ModernGaugeChartFromData(), ModernGaugeChartProps, useEnterpriseTheme(), useIsDarkMode(), ModernRingGaugeChart(), ModernRingGaugeChartFromData() (+17 more)

### Community 11 - "Community 11"
Cohesion: 0.09
Nodes (21): Message, NaturalLanguageQueryProps, DEFAULT_AI_EXPORT_CONFIG, ExportConfigModalProps, FeatureToggleRowProps, DatasetsAdminPanel(), ProjectOption, EntityWithFields (+13 more)

### Community 12 - "Community 12"
Cohesion: 0.10
Nodes (25): MagicPasteModalProps, CHART_TYPE_ROWS, chartIcons, chartTypeLabel, WidgetConfigDialogProps, CHART_TYPE_ROWS, chartIcons, chartTypeLabel (+17 more)

### Community 13 - "Community 13"
Cohesion: 0.09
Nodes (29): 10e4c1f fix: align Widget type, builder-store DB mapping, workspaces async handlers, 36cf4f9 fix: add updateDashboard to builder-store to fix TS error in workspaces, 50ab5c1 fix: persist widget layout via server API with bearer/cookie auth fallback, a109eae feat: phase 3 - setup supabase ssr clients, middleware, and db schema, cede746 fix: ensure reorderWidgets is exported from builder-store, d5ef7e8 fix: avoid PATCH writes by using upsert for dashboard/endpoint/widget updates, APIEndpoint, asRecord() (+21 more)
...
Cohesion: 0.08
Nodes (25): DashboardEndpointProbeSummary, BuilderApiHealthSummary, dispatchBuilderApiHealthRescan(), dispatchBuilderApiHealthSummary(), 222761c feat(layout): improve responsive sidebar and mobile navigation, 656733c fix(builder): move api snapshot to sidebar and persist widget sizes, 8cc9f6c fix(builder): restore widget spans and make insights on-demand, 976e623 Merge branch 'codex/builder-sidebar-health-size-persist' (+17 more)

### Community 16 - "Community 16"
Cohesion: 0.10
Nodes (26): BuilderDemoAuthSession, BuilderDemoAuthTokenMeta, clearBuilderDemoAuthSession(), decodeBase64Url(), getBuilderDemoAuthHeaders(), getBuilderDemoAuthSession(), getBuilderDemoAuthTokenExpiryMs(), getBuilderDemoAuthTokenMeta() (+18 more)

### Community 17 - "Community 17"
Cohesion: 0.11
Nodes (30): feature/phase2-sidebar-nav, 0d7f519 chore: add jszip for client-side dashboard export, 0fd0172 chore: widget-config-dialog accepts optional prefill props from suggestions, 141619a chore: ignore supabase temp directory, 15d32e3 fix(ui): show full chart names on hover in grouping chips, 1fdc423 feat(widget-config): add all 9 chart types to picker, fix ChartType record type error, 2a091ef chore: add codex skills contract file, 2dc58b0 feat: add Export as Code button wired to full export pipeline (+22 more)
...
Cohesion: 0.11
Nodes (16): TrendAnalyzer, TrendInsight, predictionConfig, trendConfig, WidgetInsights(), WidgetInsightsProps, chartTypeIcon, inferCategoryField() (+8 more)
...
Cohesion: 0.14
Nodes (17): 42e3e18 feat: complete ECharts migration + sprint bug fixes, 80b2ac7 feat(echarts): add enterprise theme registry and WidgetStyle translator utilities, 85e718d merge: sprint-3 ECharts migration + UX fixes, e6c9268 fix: sprint 1-4 comprehensive bug fixes, BOSCH_COLORS, ENTERPRISE_COLORS, colorsMatch(), FORMAT_OPTIONS (+9 more)

### Community 35 - "Community 35"
Cohesion: 0.17
Nodes (16): DataSourceCreateSchema, GET(), isMissingDataSourceSchema(), mapDataSource(), POST(), SslModeSchema, mapDataSource(), POST() (+8 more)
...
Cohesion: 0.13
Nodes (12): 1f4e14d feat(nav): redesign chart navigator to clean scrollable tab bar, 87e0fac fix(builder-ui): polish data prep modal and correct chart nav sticky layering, d3f8f10 feat(nav): macOS-inspired double-decker group navigator with dot indicator, FrozenChartNav, FrozenChartNavProps, GROUP_COLORS, GROUP_ICONS, NavGroup (+4 more)

### Community 40 - "Community 40"
Cohesion: 0.15
Nodes (8): LabelParam, ModernPieChart(), ModernPieChartProps, PieSlice, TooltipParam, truncate(), useEnterpriseTheme(), wrapLabel()

### Community 41 - "Community 41"
Cohesion: 0.20
Nodes (10): consumeSessionExpiredSignalCookie(), hasSessionExpiredSignalCookie(), hasSupabaseAuthCookieFootprint(), parseCookie(), SessionExpiredModal(), ADMIN_ONLY, clearSessionExpiredSignal(), config (+2 more)
...
Cohesion: 0.17
Nodes (12): 18a4bfe feat: complete dnd-kit context wrap on builder page, 18e6e9d feat: add viewMode prop to WidgetCard — hides edit/delete in viewer, 3001878 fix(data-analyzer): BFS depth per-node, fix id filter, fallback for all-string fields, 36f51f9 feat: merge viewer-polish, 3e0cc2d fix: add missing supabase client module for browser, 8ae130d feat: upgrade builder canvas to drag-and-drop using dnd-kit, 8d9a051 fix(builder): remove dead chart-wrapper import, fix addWidget dataMapping, sidebar widget count, b3c5f54 fix(store): prevent duplicate widget IDs from rapid magic-paste addWidget calls (+4 more)
...
Cohesion: 0.31
Nodes (10): 023e3fb merge: sprint5-monitoring-ui → dev, 172d5f6 Merge branch 'main' of https://github.com/Ujjwaldhariwal/AI-Dashboard-builder- into dev, 21ee7b8 merge(dev→main): enhanced token session timer chip, 2354c5d merge(dev): Sprint 3 — macOS double-decker group navigator, 2389a85 merge(dev→main): cleanup stash conflicts, stale branches, codex-skills, remove old docs, 49a12e6 feat(data): add safe declarative data transform layer with edit UI, 8a0b538 merge(dev): Sprint 4 — safe data transform layer with edit UI, 92fcf39 feat(monitoring): semantic icons, sortable table, structured insights (+2 more)
...
Cohesion: 0.29
Nodes (5): GET(), isMissingSchemaColumns(), AuthedSupabaseContext, getAuthedSupabase(), requirePlatformAdmin()
...
Cohesion: 0.22
Nodes (7): 02c54d5 feat(monitoring+notifs): full monitoring page, real notification store, bell wired to errors+health, 94b2b57 fix(auth): full edge-case login handling | feat(settings): back button + role badges, d6291d8 chore(next16): migrate to proxy and flat eslint config; add store migrations, AppNotification, NotificationStore, NotifType, useNotificationStore

### Community 57 - "Community 57"
Cohesion: 0.36
Nodes (8): createPostgresClient(), decryptPostgresCredential(), introspectPostgresSchema(), PostgresColumnMetadata, PostgresRuntimeOptions, PostgresTableMetadata, sslConfigForMode(), testPostgresConnection()
...
Cohesion: 0.29
Nodes (7): getWidgetCardHeightClass(), getWidgetGridSpanClass(), getWidgetSizeFromPreset(), getWidgetSizePreset(), PRESET_POSITION, WIDGET_SIZE_LABEL, WidgetPosition
...
Cohesion: 0.29
Nodes (7): 0c2ff86 feat: widget polish - loading skeleton, fullscreen, duplicate, 1ee2c2a merge: absorb origin/feature/sprint4-dnd-canvas into current next16 architecture, 2811a1f feat: add collapsible sidebar and responsive layout, 7753b5f feat: update store with duplicate, reorder, and updateDashboard, e6b82b6 fix: pass required endpointId, url, and method props to LiveAPIPreview, e9480ac docs(kt): add current-state freeze report and frontend handover, f456774 merge: absorb origin/feature/sprint3-ultra with current implementations

### Community 65 - "Community 65"
Cohesion: 0.43
Nodes (6): BusinessModelCreateSchema, GET(), isMissingSemanticSchema(), mapBusinessModel(), POST(), BusinessModelStatus
...
Cohesion: 0.40
Nodes (5): LabelParam, ModernHorizontalBarChart(), ModernHorizontalBarChartProps, TooltipParam, useEnterpriseTheme()
...
## Knowledge Gaps
- **383 isolated node(s):** `nextConfig`, `config`, `OUTPUT_ROOT`, `ZIP_PATH`, `EXTRACT_DIR` (+378 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 49`** (1 nodes): `AIInsightsEngine`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 54`** (1 nodes): `SchemaDetector`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 66`** (1 nodes): `AlertEngine`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 67`** (1 nodes): `DataAnalyzer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 70`** (1 nodes): `PDFExporter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 73`** (1 nodes): `CorrelationEngine`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 74`** (1 nodes): `ErrorBoundaryClass`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Button` connect `Community 2` to `Community 6`, `Community 21`, `Community 11`, `Community 4`, `Community 20`, `Community 45`, `Community 16`, `Community 12`, `Community 14`, `Community 33`, `Community 22`, `Community 5`, `Community 1`, `Community 15`, `Community 8`, `Community 28`, `Community 39`, `Community 3`, `Community 27`, `Community 34`, `Community 10`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `Badge()` connect `Community 2` to `Community 6`, `Community 21`, `Community 11`, `Community 4`, `Community 20`, `Community 45`, `Community 16`, `Community 12`, `Community 14`, `Community 1`, `Community 15`, `Community 8`, `Community 27`, `Community 10`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `SchemaDetector` connect `Community 54` to `Community 1`?**
