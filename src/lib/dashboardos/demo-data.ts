...
export const demoTenants: Tenant[] = [{
  ...
  status: 'active',
  primaryDomain: 'analytics.northstar.example',
  branding: null,
  createdAt: now,
  updatedAt: now,
}]
...
export const demoDataSource: DataSource = {
  ...
  name: 'Northstar Analytics Warehouse',
  type: 'postgres',
  status: 'active',
  connectionConfig: {
    host: 'analytics-replica.northstar.example',
    port: 5432,
    database: 'retail_analytics',
    username: 'dashboardos_readonly',
    sslMode: 'require',
  },
  credentialKeyId: 'vault-managed',
  lastTestedAt: now,
  lastTestStatus: 'ok',
  ...
  schemaObjectCount: 3,
  schemaBaseTableCount: 3,
  schemaViewCount: 0,
  schemaIncludedObjectCount: 3,
  schemaIncludedColumnCount: 14,
  schemaExcludedObjectCount: 0,
  schemaReviewObjectCount: 0,
  schemaScopeStatus: 'confirmed',
...
export const demoModel: BusinessModel = {
  ...
  description: 'Approved semantic layer for governed executive revenue reporting.',
  status: 'approved',
  version: 1,
  createdAt: now,
  updatedAt: now,
...
export const demoDataset: SemanticDataset = {
  ...
  description: 'Published dataset for executive revenue, order, and customer reporting.',
  status: 'published',
  selection: {
...
export const demoDashboard: PublishedDashboard = {
  ...
  description: 'Published executive revenue dashboard for Northstar Retail.',
  status: 'published',
...
export const demoVersion: DashboardVersion = {
  ...
  versionNumber: 1,
  status: 'published',
  title: 'Executive revenue release',
  notes: 'Reviewed multi-chart release approved for the client-facing workspace.',
